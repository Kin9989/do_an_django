...
export const ORDER_STATS_UP_REQUEST = 'ORDER_STATS_UP_REQUEST';
export const ORDER_STATS_UP_SUCCESS = 'ORDER_STATS_UP_SUCCESS';
export const ORDER_STATS_UP_FAIL = 'ORDER_STATS_UP_FAIL';