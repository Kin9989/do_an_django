...
# )
# VNPAY_TMN_CODE = os.environ.get("VNPAY_TMN_CODE", "3OMWHBJ6")
# VNPAY_HASH_SECRET_KEY = os.environ.get(
#     "VNPAY_HASH_SECRET_KEY", "NQ50U2ATQNX2D8GDLM3DW6XO9NCNGC3W"
# )
...
VNPAY_RETURN_URLSuccess = os.environ.get(
    "VNPAY_RETURN_URLSuccess", "http://localhost:3000/#/pay/success"
)
VNPAY_PAYMENT_URL = os.environ.get(
    "VNPAY_PAYMENT_URL", "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html"
)
...
VNPAY_TMN_CODE = os.environ.get("VNPAY_TMN_CODE", "B5Q0RLS2")
VNPAY_HASH_SECRET_KEY = os.environ.get(
